 ...
 * @param {Image} props.img The image on the background of the BigBanner
 * @param {string} props.imgAlt The alt caption for the image on the background
 * @param {string} props.boardSlogan This year's board slogan
 * @returns {React.Fragment} The BigBanner component.
 */
type BigBannerProps = {
        ...
        <div className="z-20 absolute top-[80%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
          ...
          <div className="grid place-content-center py-4 my-2">
            <Link
              href="#"
              passHref
              className="group flex text-sm sm:text-md md:text-lg h-10 items-center gap-2 rounded-full border-2 border-white bg-transparent pl-3 pr-4 transition-all duration-300 ease-in-out hover:bg-black hover:bg-opacity-50 hover:pl-2 hover:text-white active:bg-neutral-700 min-w-[215px]"
            >
